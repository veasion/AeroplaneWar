...
public class Resource {
	...
	public final static Image[] IMAGE_Enemy = { IMAGE_Enemy01, IMAGE_Enemy02, IMAGE_Enemy03, IMAGE_Enemy04,
			IMAGE_Enemy05, IMAGE_Enemy06, IMAGE_Enemy07, IMAGE_Enemy08, IMAGE_Enemy09 };
	// 敌方子弹
	...
	public final static Image[] IMAGE_EnemyBullets = new Image[] { IMAGE_EnemyBullet01, IMAGE_EnemyBullet02,
			IMAGE_EnemyBullet03, IMAGE_EnemyBullet04, IMAGE_EnemyBullet05 };
	// 敌方大Boss
	public final static Image[] IMAGE_EnemyBoss01 = new Image[] {
			ResourceUtil.loadImage(IMAGE_PATH + "EnemyBoss01_1.png"),
			ResourceUtil.loadImage(IMAGE_PATH + "EnemyBoss01_2.png") };
	public final static Image[] IMAGE_EnemyBoss02 = new Image[] {
			ResourceUtil.loadImage(IMAGE_PATH + "EnemyBoss02_1.png"),
			ResourceUtil.loadImage(IMAGE_PATH + "EnemyBoss02_2.png") };
	...
	public final static Image[] IMAGE_Explosion = { IMAGE_Explosion01, IMAGE_Explosion02, IMAGE_Explosion03,
			IMAGE_Explosion04, IMAGE_Explosion05, IMAGE_Explosion06, IMAGE_Explosion07 };
